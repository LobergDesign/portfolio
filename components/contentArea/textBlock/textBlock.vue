		...
		<div class="container">
			<div class="row flex-center-center">
				<div class="col-xl-5 col-lg-8">
					<h3 class="intro set-animation">{{ data.intro }}</h3>
				</div>
			</div>
			<div class="row flex-horizontal-center">
				<div class="col-lg-5 set-animation" v-if="data.firstRteSection">
					<div v-html="toHtmlString(data.firstRteSection.json)"></div>
				</div>
				<div class="col-lg-5 set-animation" v-if="data.secondRteSection">
					<div v-html="toHtmlString(data.secondRteSection.json)"></div>
				</div>
			</div>
			<div class="row flex-center-center" v-if="data.link">
				<div class="col-lg-5 set-animation">
